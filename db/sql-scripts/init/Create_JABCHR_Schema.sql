...
CREATE TABLE IF NOT EXISTS `jabc_db`.`SUPPORT_DOC` (
  ...
  CONSTRAINT `FK_TYPE_ID`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_EMPLOYEE_ID_SUPPORT_DOC`
...
CREATE TABLE IF NOT EXISTS `jabc_db`.`MANAGER_EMPLOYEE` (
  ...
  CONSTRAINT `FK_MANAGER_ID`
    ...
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_EMPLOYEE_ID_MANAGER_EMPLOYEE`
    FOREIGN KEY (`EMPLOYEE_ID`)
    REFERENCES `jabc_db`.`HR_RECORD` (`EMPLOYEE_ID`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `jabc_db`.`VACATION_REQUEST` (
  ...
  CONSTRAINT `FK_EMPLOYEE_ID_VACATION_REQUEST`
    FOREIGN KEY (`EMPLOYEE_ID`)
    REFERENCES `jabc_db`.`HR_RECORD` (`EMPLOYEE_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `jabc_db`.`PERFORMANCE` (
  ...
  INDEX `fk_PERFORMANCE_HR_RECORD1_idx` (`EMPLOYEE_ID` ASC),
  CONSTRAINT `fk_PERFORMANCE_HR_RECORD1`
    FOREIGN KEY (`EMPLOYEE_ID`)
    REFERENCES `jabc_db`.`HR_RECORD` (`EMPLOYEE_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `jabc_db`.`PERSONAL_TARGET` (
  ...
  INDEX `fk_PERSONAL_TARGET_PERFORMANCE1_idx` (`PERFORMANCE_ID` ASC),
...
CREATE TABLE IF NOT EXISTS `jabc_db`.`OBJECTIVE` (
  ...
  INDEX `fk_OBJECTIVE_has_PERFORMANCE_PERFORMANCE1_idx` (`PERFORMANCE_ID` ASC),
...
CREATE TABLE IF NOT EXISTS `jabc_db`.`DEVELOPMENT_GOAL` (
  ...
  INDEX `fk_DEVELOPMENT_GOAL_PERFORMANCE1_idx` (`PERFORMANCE_ID` ASC),
...
CREATE TABLE IF NOT EXISTS `jabc_db`.`PROBATION` (
  ...
  INDEX `fk_PROBATION_HR_RECORD1_idx` (`EMPLOYEE_ID` ASC),
  CONSTRAINT `fk_PROBATION_HR_RECORD1`
    FOREIGN KEY (`EMPLOYEE_ID`)
    REFERENCES `jabc_db`.`HR_RECORD` (`EMPLOYEE_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `jabc_db`.`JABC_GOAL` (
  ...
  INDEX `fk_JABC_GOAL_PERFORMANCE1_idx` (`PERFORMANCE_ID` ASC),
...
CREATE TABLE IF NOT EXISTS `jabc_db`.`COMMENT` (
  ...
  INDEX `fk_COMMENT_PERFORMANCE1_idx` (`PERFORMANCE_ID` ASC),
  INDEX `fk_COMMENT_HR_RECORD1_idx` (`COMMENTER_EMPLOYEE_ID` ASC),
  CONSTRAINT `fk_COMMENT_PERFORMANCE1`
    FOREIGN KEY (`PERFORMANCE_ID`)
    REFERENCES `jabc_db`.`PERFORMANCE` (`PERFORMANCE_ID`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_COMMENT_HR_RECORD1`
    FOREIGN KEY (`COMMENTER_EMPLOYEE_ID`)
    REFERENCES `jabc_db`.`HR_RECORD` (`EMPLOYEE_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
