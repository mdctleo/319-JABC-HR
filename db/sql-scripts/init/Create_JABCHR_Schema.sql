...
(1, 1, 1, 1, 111111111, 'tflenderson@jabc.com', 'Toby', 'Flenderson', 'hr_test_road', '1969-11-30', 20, 10, 1, 1, 'nwa7YhtRIeV8T/FNweFqag==', '200.00', '1989-12-01', 2, '1989-12-01', '6041111111');

INSERT INTO `HR_RECORD` (`EMPLOYEE_ID`, `VERSION`, `CREATED_BY`, `ROLE`, `SIN`, `EMAIL`, `FIRST_NAME`, `LAST_NAME`, `ADDRESS`, `BIRTHDATE`, `VACATION_DAYS`, `REMAINING_VACATION_DAYS`, `FTE`, `STATUS`, `PASSWORD`, `SALARY`, `DATE_JOINED`, `ADMIN_LEVEL`, `CREATED_DATE`, `PHONE_NUMBER`) VALUES
(2, 1, 1, 1, 222222222, 'mscott@jabc.com', 'Michael', 'Scott', '3333 Maple road', '1964-12-08', 20, 0, 1, 1, 'sYzMmy1bSlYQLCKMLT9ljQ==', '5000.00', '1989-12-01', 1, '1989-01-01', '6042222222');

INSERT INTO `HR_RECORD` (`EMPLOYEE_ID`, `VERSION`, `CREATED_BY`, `ROLE`, `SIN`, `EMAIL`, `FIRST_NAME`, `LAST_NAME`, `ADDRESS`, `BIRTHDATE`, `VACATION_DAYS`, `REMAINING_VACATION_DAYS`, `FTE`, `STATUS`, `PASSWORD`, `SALARY`, `DATE_JOINED`, `ADMIN_LEVEL`, `CREATED_DATE`, `PHONE_NUMBER`) VALUES
(3, 1, 1, 2, 333333333, 'jhalpert@jabc.com', 'Jim', 'Halpert', '8888 Halpert road', '1979-09-03', 10, 10, 1, 1, 'pMuAndRnqrN9IFUAlPos9Q==', '3000.00', '2002-04-01', 0, '2002-04-01', '6043333333');

INSERT INTO `HR_RECORD` (`EMPLOYEE_ID`, `VERSION`, `CREATED_BY`, `ROLE`, `SIN`, `EMAIL`, `FIRST_NAME`, `LAST_NAME`, `ADDRESS`, `BIRTHDATE`, `VACATION_DAYS`, `REMAINING_VACATION_DAYS`, `FTE`, `STATUS`, `PASSWORD`, `SALARY`, `DATE_JOINED`, `ADMIN_LEVEL`, `CREATED_DATE`, `PHONE_NUMBER`) VALUES
(4, 1, 1, 2, 444444444, 'dschrute@jabc.com', 'Dwight', 'Schrute', 'Schrute Farm', '1978-10-30', 10, 8, 1, 1, 'pMuAndRnqrN9IFUAlPos9Q==', '3000.0', '2000-03-01', 0, '2000-04-01', '6044444444');

INSERT INTO `HR_RECORD` (`EMPLOYEE_ID`, `VERSION`, `CREATED_BY`, `ROLE`, `SIN`, `EMAIL`, `FIRST_NAME`, `LAST_NAME`, `ADDRESS`, `BIRTHDATE`, `VACATION_DAYS`, `REMAINING_VACATION_DAYS`, `FTE`, `STATUS`, `PASSWORD`, `SALARY`, `DATE_JOINED`, `ADMIN_LEVEL`, `CREATED_DATE`, `PHONE_NUMBER`) VALUES
(5, 1, 1, 3, 555555555, 'kfilippelli@jabc.com', 'Karen', 'Filippelli', 'Exotic Land', '1980-01-30', 10, 8, 1, 1, 'pMuAndRnqrN9IFUAlPos9Q==', '3000.0', '2004-02-01', 1, '2004-02-03', '6045555555');
